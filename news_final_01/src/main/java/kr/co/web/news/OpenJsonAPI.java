...
public class OpenJsonAPI {
	...
	public <T> T get(String baseurl, String params, TypeReference valueTypeRef) {
		try {
            ...
            T news = mapper.readValue(br, valueTypeRef);
	...
	public <T> T post(String baseurl, String params, TypeReference valueTypeRef) {
		try {
